...
<form class="w-full max-w-sm" method="POST" action="{{$route}}">
    ...
    @foreach($movieArray as $movie)
        ...
        <input id="movie" name="movie" type="hidden" value="{{"$movie[id]"}}">
    @endforeach
    ...
    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0 m-4">
        ...
        <select  id="turn" name="turn" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
